...
const main = () => {
  ...
  console.log("Total Number of houses which santa visited at least once", totalHouseVisited1);
  console.log("Total number of houses which santa and robo santa visited at least once", totalHouseVisited2);
};
